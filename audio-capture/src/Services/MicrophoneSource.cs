...
public sealed class MicrophoneSource : IDisposable
{
 ...
 public MicrophoneSource(ILogger<MicrophoneSource> log){ _log = log; }
 ...
 _log.LogInformation("Microphone capture started on: {Name}, Format={Format}", device.FriendlyName, _capture.WaveFormat);
